...
As you can see, you can construct any model with a mathematical expression. Every recursive function will check that the supplied list of parameters corresponds to this expression.
